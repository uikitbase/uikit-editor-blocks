...
class Uikit_Editor_Blocks {
    ...
    public function includes() {
        ...
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/uikit-editor-blocks-functions.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/class-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/class-settings.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/general-attributes-helpers.php';

        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-accordion-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-accordion-item-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-alert-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-button-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-card-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-container-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-divider-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-dropdown-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-dropdown-item-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-grid-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-grid-column-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-heading-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-icon-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-image-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-overlay-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-overlay-slider-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-overlay-slider-item-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-panel-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-panel-slider-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-panel-slider-item-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-quotation-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-section-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-slideshow-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-slideshow-item-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-social-icons-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-social-icons-item-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-switcher-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-switcher-item-block-type.php';
        require_once UIKIT_EDITOR_BLOCKS_ABSPATH . 'includes/blocks/class-text-block-type.php';
    }
