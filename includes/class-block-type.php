...
if ( ! class_exists( '\Uikit_Editor_Blocks\Block_Type', false ) ) :
    ...
    abstract class Block_Type {
        ...
        /**
         * Whether the block should inherit the general UIkit attributes (margin, animation, etc.).
         * Set to true in child classes to enable.
         *
         * @var bool
         */
        protected $has_general_attributes = false;
        ...
        public function register_block_type() {
            if ( $this->has_general_attributes ) {
                $this->attributes         = array_merge( uikit_editor_blocks_get_general_attributes(), $this->attributes );
                $this->default_attributes = array_merge( uikit_editor_blocks_get_general_default_attributes(), $this->default_attributes );
            }
