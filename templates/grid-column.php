...
$overlay_attrs   = [];
$overlay_classes = ['uk-position-cover'];
$overlay_styles  = [];
...
if ( $attributes['bgImageMediaId'] ) {
    if ( $attributes['bgImageOverlay'] ) {
        if ( $attributes['bgImageOverlayColor'] ) {
            $overlay_styles[] = 'background-color: ' . $attributes['bgImageOverlayColor'];
        }
    }
}
...
<div <?php echo implode( ' ', $wrapper_attrs ); ?>>
    <div <?php echo implode( ' ', $content_attrs ); ?>>
        <?php if ( $attributes['bgImageMediaId'] && $attributes['bgImageOverlay'] ) : ?>
        <div <?php echo implode( ' ', $overlay_attrs ); ?>></div>
        <?php endif; ?>
        <?php if ( $attributes['verticalAlignment'] || ( $attributes['bgImageMediaId'] && $attributes['bgImageOverlay'] ) ) : ?>
        <div class="uk-panel">
        <?php endif; ?>
