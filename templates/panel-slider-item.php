 ...
 * Wrapper classes
 */
if ( $block->context['uikit-editor-blocks/panel-slider-sliderWidth'] === 'fixed' ) {
 ...
 * Image styles
 */
if ( $attributes['imageMediaId'] && $block->context['uikit-editor-blocks/panel-slider-imageWidth'] ) {
    $image_styles[] = 'width: ' . $block->context['uikit-editor-blocks/panel-slider-imageWidth'] . 'px';
}

if ( $attributes['imageMediaId'] && $block->context['uikit-editor-blocks/panel-slider-imageHeight'] ) {
