 ...
 * Wrapper slider-data
 */
if ( $attributes['sliderAutoplay'] ) {
    $wrapper_slider_data[] = 'autoplay: 1';
}
...
/**
 * Slider height-viewport-data
 */
if( $attributes['sliderWidth'] === 'fixed' ) {
    if( $attributes['sliderHeight'] ) {
        $slider_height_viewport_data[] = 'offset-top: true';
        $slider_height_viewport_data[] = 'minHeight: ' . $attributes['sliderMinHeight'];
    }
}
...
if ( $attributes['slidenavPosition'] ) {
    if ( $attributes['slidenavPosition'] === 'default' ) {
        $slidenav_left_classes[] = 'uk-position-medium uk-position-center-left';
    }
}
...
if ( $attributes['slidenavPosition'] ) {
    if ( $attributes['slidenavPosition'] === 'default' ) {
        $slidenav_right_classes[] = 'uk-position-medium uk-position-center-right';
    }
}
 ...
 */
$wrapper_classes = apply_filters( 'uikit_editor_blocks_overlay_slider_classes', $wrapper_classes, $attributes );
...
$wrapper_attrs[] = 'data-uk-slider="' . esc_attr( implode( '; ', $wrapper_slider_data ) ) . '"';
...
if( $slider_height_viewport_data ) {
    $slider_attrs[] = 'data-uk-height-viewport="' . esc_attr( implode( '; ', $slider_height_viewport_data ) ) . '"';
}
