 ...
 * Wrapper classes
 */
if ( $block->context['uikit-editor-blocks/overlay-slider-sliderWidth'] && $block->context['uikit-editor-blocks/overlay-slider-sliderWidth'] === 'fixed' ) {
 ...
 * Image styles
 */
if ( $block->context['uikit-editor-blocks/overlay-slider-imageWidth'] ) {
    $image_styles[] = 'width: ' . $block->context['uikit-editor-blocks/overlay-slider-imageWidth'] . 'px';
}

if ( $block->context['uikit-editor-blocks/overlay-slider-imageHeight'] ) {
